    ...
    <div className="form">
     <Grid container spacing={12}>
      ...
      <Grid container spacing={40}>
        ...
        <Grid item xs={3}>
          <TextField fullWidth variant="outlined" label="First Name" required="true"/>
        </Grid>
        
        <Grid item xs={3}>
          <TextField fullWidth variant="outlined" label="Last Name" required="true"/>
        </Grid>
        <Grid item xs={1}>
          <TextField fullWidth variant="outlined" label="M.I." required="true"/>
        </Grid>
       </Grid>
       <br/>
       <Grid container spacing={12}>
       ...
       <Grid container spacing={24}>
        <Grid item xs={3}>
          <TextField fullWidth label="Current Address: Street and Number" required="true" />
        </Grid>
        ...
        <Grid item xs={2}>
          <TextField fullWidth label="Diver's license number" required="true"/>
        </Grid>
        <Grid item xs={2}>
        <TextField fullWidth label="State of issued license" required="true"/>
        </Grid>
        <Grid item xs={3}>
          <TextField
            fullWidth
